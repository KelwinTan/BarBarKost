...
class DetailLeaflet extends Component {
  constructor(props) {
    super(props);
    this.state = {
      popup: L.popup(),
  ...
  onLocationFound = e => {
    ...
    var radius = e.accuracy / 2;
    // var data["lat"] = this.props.lat;
    // const data["lat"] = this.props.lat
    console.log(this.props.lat);
    console.log(this.props.lng);

    this.state.Marker = L.circleMarker({lat: this.props.lat, lng: this.props.lng});
  ...
  render() {
    return <Wrapper width="1000px" height="500px" id="map" className="kost-detail-responsive"/>;
  }
}

export default DetailLeaflet;
